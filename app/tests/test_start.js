...
require('./spec/lib/experiments/password-strength');
...
require('./spec/lib/experiments/grouping-rules/password-strength');
...
require('./spec/views/mixins/password-strength-experiment-mixin');
